...
<div class = "maindiv" id = "order">
  <h2 class="formLabel" style="text-align:center;">فرم سفارش بازی</h2>
  <hr class = "underLineHr" >
  <div class="row ">
    <div class="container ">
      <form method="post" action="/gameorder">
        ...
        <div class="col-xs-12 col-md-6">
          <div class="form-group">
            ...
            <div class="form-group">
              <label for="orderType" class="formLabel">سبک بازی:</label>
              <select class="form-control" id="orderType" required="required">
                <option>آموزشی</option>
                <option>استراتژی</option>
                <option>اکشن</option>
                <option>مسایقه‌ای</option>
                <option>تفننی</option>
                <option>خانوادگی</option>
                <option>رانندگی</option>
                <option>شبیه‌سازی</option>
                <option>کلمات و دانستنی‌ها</option>
                <option>ماجرایی</option>
                <option>معمایی</option>
                <option>ورزشی</option>
                <option>درخواست همکاری در پروژه </option>
              </select>
            </div>
            <div class="form-group">
