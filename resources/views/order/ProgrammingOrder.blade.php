...
<div class = "maindiv" id = "order">
  <h2 class="formLabel" style="text-align:center;">فرم سفارش برنامه</h2>
  <hr class = "underLineHr" >
  <div class="row ">
    <div class="container ">
      <form method="post" action="/programmerorder">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              ...
              <select class="form-control" id="orderType" required="required">
                ...
                <option>اپلیکیشن اندروید</option>
                <option>اپلیکیشن دسکتاپ</option>
                <option>پروژه ترکیبی</option>
