  ...
  <div class="container">
    ...
    <form class="" action="#" method="post">
      <div class="form-group">
        ...
        <input type="text" class="form-control " id="postTitle" name="postTitle" placeholder="عنوان را وارد کنید" required="required">
      </div>
      <div class="form-group">
        <label for="comment" class="formLabel">پست :</label>
        <textarea class="form-control" rows="16" id="postContent" name = "postContent" required="required"></textarea>
      </div>
